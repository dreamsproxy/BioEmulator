...
class Network:
    def __init__(self, num_neurons:int, n_inputs:int, encodings:np.ndarray, dt:float = 0.1, shape = (28, 28)) -> None:
        self.shape = shape
        ...
        self.input_weights = np.random.uniform(-0.9, 0.9, (self.n_inputs, self.num_neurons))
        self.output_weights = np.random.uniform(-0.9, 0.9, (self.n_inputs, self.num_neurons)) # Data reconstruction mode
